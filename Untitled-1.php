...
$city = 'Барнаул, Россия'; // строка

$profi = 'Тестировщик'; // строка

$email = 'email@email.ru'; // строка

$phone = 89132207412; // десятичное число можно без ковычек
...
$exp = [
'name' =>[' QA Ingineer', ' Web Developer', ' Graphic Designer'],
'date' => ['Jan 2015- May 2022', ' Mar 2012 - Dec 2014', ' Jun 2010 - Mar 2012'],
            ...
            <div class="w3-third">
                ...
                <div class="w3-white w3-text-grey w3-card-4">
                    ...
                    <div class="w3-display-container">
                        ...
                        <img src="https://sun6-22.userapi.com/s/v1/ig2/Or96LLNzRco-RuODf9p_HpAb8kLaj5IjdSvhe0cHysT4MpBF-z1cLXu2r7ZoRZz5ENsQ2EA52FujkEA9BmTn4DMY.jpg?size=1100x1100&quality=95&crop=96,0,1100,1100&ava=1"
                    ...
                    <div class="w3-container">
                        ...
                        <p>
                            <?php echo $skills['name'][1]; ?>
                        </p>

                        <div class="w3-light-grey w3-round-xlarge w3-small">

                            <div class="w3-container w3-center w3-round-xlarge w3-teal"
                                style="width:<?php echo $skills['level'][1]; ?>%">

                                <div class="w3-center w3-text-white">
                                    <?php echo $skills['level'][1]; ?>%
                                </div>
                        ...
                        <p>
                            <?php echo $skills['name'][2]; ?>
                        </p>

                        <div class="w3-light-grey w3-round-xlarge w3-small">

                            <div class="w3-container w3-center w3-round-xlarge w3-teal"
                                style="width:<?php echo $skills['level'][2]; ?>%">
                                <?php echo $skills['level'][2]; ?>%
                            </div>

                        </div>

                        <p>
                            <?php echo $skills['name'][3]; ?>
                        </p>

                        <div class="w3-light-grey w3-round-xlarge w3-small">

                            <div class="w3-container w3-center w3-round-xlarge w3-teal"
                                style="width:<?php echo $skills['level'][3]; ?>%">
                                <?php echo $skills['level'][3]; ?>%
                            </div>
            ...
            <div class="w3-twothird">
                ...
                <div class="w3-container w3-card w3-white w3-margin-bottom">
                    ...
                    <div class="w3-container">
                        ...
                        <h5 class="w3-opacity"><b><?php echo $exp ['name'][0]; ?></b></h5>

                        <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $exp ['date'][0]; ?>
                        </h6>

                        <p><?php echo $exp ['text'][0]; ?></p>
                    ...
                    <div class="w3-container">
                        ...
                        <h5 class="w3-opacity"><b><?php echo $exp ['name'][2]; ?></b></h5>

                        <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $exp ['date'][0]; ?>
                        </h6>

                        <p><?php echo $exp ['text'][2]; ?> </p><br>
